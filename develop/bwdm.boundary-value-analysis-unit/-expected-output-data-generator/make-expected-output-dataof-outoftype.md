[bwdm.boundaryValueAnalysisUnit](../index.md) / [ExpectedOutputDataGenerator](index.md) / [makeExpectedOutputDataofOutoftype](./make-expected-output-dataof-outoftype.md)
